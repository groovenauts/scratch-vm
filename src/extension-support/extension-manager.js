...
const builtinExtensions = {
    ...
    rockPaperScissors: () => require('../extensions/scratch3_rock_paper_scissors'),
    imageDetection: () => require('../extensions/scratch3_image_detection'),
    soundDetection: () => require('../extensions/scratch3_sound_detection'),
    imagenet: () => require('../extensions/scratch3_imagenet'),
